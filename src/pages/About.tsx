...
import rackDetail from "@/assets/rack-lite-3.jpg";

const achievements = [
  { number: "500+", label: "Установленных залов" },
  { number: "10 000+", label: "Единиц оборудования" },
  { number: "5", label: "Лет на рынке" },
  { number: "50+", label: "Моделей тренажеров" },
];
    ...
    <Layout>
      ...
      <section className="section-padding bg-card">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img src={rackDetail} alt="Детали оборудования HAGL" className="w-full h-auto" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {achievements.map((a, i) => (
              ...
              >
                <p className="font-heading text-4xl md:text-5xl text-primary mb-2">{a.number}</p>
